...
class Mark(models.Model):
    ...
    student_reg_no = models.CharField('Student Register Number', max_length=100)
    ...
    staff_id =  models.IntegerField('Teacher Id',null=True)
    mark = models.IntegerField('Mark',null=True)
    exam_id = models.IntegerField('Exam Id',null=True)
